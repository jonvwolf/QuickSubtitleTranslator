...
namespace QuickSubtitleTranslator.MicrosoftApi
{
    public class MicrosoftTranslator : ITranslationService
    {
        ...
        public MyTranslateResult Translate(string from, string to, IReadOnlyList<MySubtitleItem> subtitles, string apiKey, bool waitForInput, long maxCharactersToSend, bool peek)
        {
